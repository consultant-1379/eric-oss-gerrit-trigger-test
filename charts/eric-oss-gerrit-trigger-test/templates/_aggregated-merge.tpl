...
*/ -}}
{{- define "eric-oss-gerrit-trigger-test.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-gerrit-trigger-test.mergeAnnotations" -}}
  {{- include "eric-oss-gerrit-trigger-test.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-gerrit-trigger-test.mergeLabels" -}}
  {{- include "eric-oss-gerrit-trigger-test.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
